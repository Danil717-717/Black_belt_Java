...
public class Ex06DataInputOutpStream {
    public static void main(String[] args) {
        try (DataOutputStream outputStream = new
                DataOutputStream(new FileOutputStream("./src/main/java/work_with_files/my_test.bin"));
             DataInputStream inputStream = new
                     DataInputStream(new FileInputStream("./src/main/java/work_with_files/my_test.bin"))){
