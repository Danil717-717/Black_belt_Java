...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        // бинарный поиск только на отсортированном массиве
        // делит массив пополам, больше меньше, если больше идет вправо
        // если меньше идет влево, потом опять пополам и тд
        ...
        Collections.sort(arrayList); //сортировка массива
        System.out.println(arrayList);

        Collections.reverse(arrayList);//сортирует и переворачивает массив
        System.out.println(arrayList);

        Collections.shuffle(arrayList); //перемешивает массив
        System.out.println(arrayList);
